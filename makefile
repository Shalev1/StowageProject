COMP = g++-8.3.0
OBJS = main.o Simulator.o ShipPlan.o Floor.o Spot.o Container.o Port.o Route.o Utils.o Algorithm.o WeightBalanceCalculator.o AlgorithmReverse.o
EXEC = ex1
...
Simulator.o: Simulator.cpp Simulator.h Algorithm.h ShipPlan.h Floor.h Spot.h Container.h Route.h Port.h Utils.h WeightBalanceCalculator.h AlgorithmReverse.h
	$(COMP) $(CPP_COMP_FLAG) -c $*.cpp
...
WeightBalanceCalculator.o: WeightBalanceCalculator.cpp WeightBalanceCalculator.h ShipPlan.h Floor.h Spot.h Container.h
	$(COMP) $(CPP_COMP_FLAG) -c $*.cpp
Algorithm.o: Algorithm.cpp Algorithm.h ShipPlan.h Floor.h Spot.h Container.h Route.h Port.h Utils.h WeightBalanceCalculator.h
	$(COMP) $(CPP_COMP_FLAG) -c $*.cpp
AlgorithmReverse.o: AlgorithmReverse.cpp AlgorithmReverse.h Algorithm.h ShipPlan.h Route.h
	$(COMP) $(CPP_COMP_FLAG) -c $*.cpp
clean:
	rm -f $(OBJS) $(EXEC)
